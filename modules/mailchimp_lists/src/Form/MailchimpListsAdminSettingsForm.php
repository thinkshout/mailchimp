 ...
 */
class MailchimpListsAdminSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormID() {
    return 'mailchimp_lists_admin_settings';
  }

  protected function getEditableConfigNames() {
    return ['mailchimp_lists.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('mailchimp_lists.settings');
