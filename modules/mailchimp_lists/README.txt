Synchronize Drupal entities with MailChimp lists and allow users to subscribe, 
...
* Go to http://example.com/admin/config/services/mailchimp/signup
...
fields are required or not required based on Mailchimp's merge field settings.
