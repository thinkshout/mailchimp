$Id:
This module provides integration with the MailChimp (http://mailchimp.com) email delivery service. I needed it for a community focused site, and we found the "internal" tools like simple news a bit lacking, especially in terms of composition, delivery, and reporting.
...
Big thanks to Ronan Downing (http://drupal.org/user/72815) for his help in development.
